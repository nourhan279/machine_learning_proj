...
# Save results
os.makedirs("data/MobileNet_features", exist_ok=True)
joblib.dump(X_train_cnn, "data/MobileNet_features/train_features.pkl")
joblib.dump(y_train,     "data/MobileNet_features/train_labels.pkl")
joblib.dump(X_val_cnn,   "data/MobileNet_features/val_features.pkl")
joblib.dump(y_val,       "data/MobileNet_features/val_labels.pkl")
